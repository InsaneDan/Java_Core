package lesson2.server.chat;


import lesson2.clientserver.Command;
import lesson2.server.chat.auth.AuthService;
...
//            System.out.println("Сервер запущен");
            ...
            System.err.println("Не удалось установить новое соединение");
            logger.warning("Не удалось установить новое соединение");
        ...
        Thread serverMessageThread = new Thread(() -> {
            ...
            while (true) {
                ...
                try {
                    ...
                    System.err.println("Не удалось передать серверное сообщение");
                    logger.warning("Не удалось передать серверное сообщение");
                    e.printStackTrace();
                }
            }
        });
...
//        System.out.println("Ожидание нового подключения....");
        logger.fine("Ожидание нового подключения");
...
//        System.out.println("Клиент подключился");// /auth login password
    ...
    public void usersListUpdate() throws IOException {
        notifyClientsUsersListUpdated(clients);
    }
